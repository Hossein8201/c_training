...
int main(){
    ...
    // }
    if(destination%4==0)    printf("%d %d",destination*(-1)/4,destination/4);
    else if(destination%4==1){    destination-=1;    printf("%d %d",-1*destination/4,-1*destination/4);}
    else if(destination%4==2){    destination-=2;    printf("%d %d",destination/4+1,-1*destination/4);}
    else{     destination-=3;    printf("%d %d",destination/4+1,destination/4+1);}
}